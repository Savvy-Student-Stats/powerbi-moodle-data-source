...
# Notion
https://www.notion.so/sqrldotca/PowerBI-4a6e06436e3846dbafdb316f3a33f19e

Easier to paste screenshots there.
...
let
    ...
    #"Added Custom" = Table.AddColumn(#"Reordered Columns1", "_stats.isGradeable", each if [gradeitems.gradedategraded] is null then 
   if [gradeitems.gradedatesubmitted] is null
       then false
       else true
else true),
    #"Reordered Columns2" = Table.ReorderColumns(#"Added Custom",{"_stats.isGradeable", "gradeitems.graderaw", "_calc.dateGraded", "_calc.dateSubmitted", "_calc.wasSubmitted", "Source.Name", "courseid", "userid", "userfullname", "maxdepth", "gradeitems.id", "gradeitems.itemname", "gradeitems.itemtype", "gradeitems.itemmodule", "gradeitems.iteminstance", "gradeitems.itemnumber", "gradeitems.categoryid", "gradeitems.scaleid", "gradeitems.locked", "gradeitems.gradedatesubmitted", "gradeitems.gradedategraded", "gradeitems.gradehiddenbydate", "gradeitems.gradeneedsupdate", "gradeitems.gradeishidden", "gradeitems.gradeislocked", "gradeitems.gradeisoverridden", "gradeitems.gradeformatted", "gradeitems.feedback", "gradeitems.feedbackformat", "gradeitems.cmid"}),
    #"Filtered Rows2" = Table.SelectRows(#"Reordered Columns2", each ([_stats.isGradeable] = true)),
    #"Added Custom1" = Table.AddColumn(#"Filtered Rows2", "_stats.isGradeableText", each SWITCH([_calc.wasSubmitted], TRUE, "Yes", FALSE, "No"))
in
    #"Added Custom1"
```
